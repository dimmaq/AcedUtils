...
type
  TAnsiStringBuilder = class(TObject)
  private
    FLength: Integer;
    FCapacity: Integer;
    FChars: PChars;
  ...
  {  }
    ...
    procedure CopyFrom(ASource: TAnsiStringBuilder);
  ...
  { Следующая функция Append добавляет к строке десятичное представление
    ...
    function Append(N: Integer): TAnsiStringBuilder; overload;
  ...
  { Следующая функция Append добавляет к строке десятичное (если параметр
    ...
    function Append(N: LongWord; Digits: Integer; Hexadecimal: Boolean = False): TAnsiStringBuilder; overload;
  ...
  { Следующая функция Append добавляет Count копий символа C в конец строки и
    ...
    function Append(C: AnsiChar; Count: Integer): TAnsiStringBuilder; overload;

  { Следующая функция Append добавляет строку S в конец данной строки и
    возвращает ссылку на данный экземпляр класса TStringBuilder. }

    function Append(const S: AnsiString): TAnsiStringBuilder; overload;
  ...
  { Следующая функция Append добавляет Count копий строки S в конец данной
    ...
    function Append(const S: AnsiString; Count: Integer): TAnsiStringBuilder; overload;
  ...
  { Следующая функция Append добавляет фрагмент строки S, начиная с позиции
    ...
    function Append(const S: AnsiString; StartIndex, Count: Integer): TAnsiStringBuilder; overload;
  ...
  { Следующая функция Append добавляет в конец строки L символов, адресуемых
    ...
    function Append(P: Pointer; L: Integer): TAnsiStringBuilder; overload;
  ...
  { Следующая функция AppendLine добавляет в конец строки символы перевода
    ...
    function AppendLine: TAnsiStringBuilder; overload;
  ...
  { Следующая функция AppendLine добавляет строку S в конец данной строки,
    ...
    function AppendLine(const S: AnsiString): TAnsiStringBuilder; overload;

    function AppendFormat(const Format: AnsiString; const Args: array of const): TAnsiStringBuilder;
  ...
  { Метод Delete удаляет из строки фрагмент длиной Count символов, начиная с
    ...
    // удаляет Count буквок начиная с Index и вставляет на это место строку S
    procedure Replace(Index, Count: Integer; const S: AnsiString);
  ...
  { Функция ToString возвращает строку типа AnsiString, соответствующую строке,
    ...
    function ToString: AnsiString;{$IFDEF UNICODE} reintroduce;{$ENDIF} overload;
    function ToString(Index, Count: Integer): AnsiString;{$IFDEF UNICODE} reintroduce; {$ENDIF} overload;
  ...
  { Функция Equals возвращает True, если текущее значение строки равно
    ...
    function Equals(SB: TAnsiStringBuilder): Boolean;{$IFDEF UNICODE} reintroduce; overload;{$ENDIF}
  ...
  { Функция Clone возвращает экземпляр класса TStringBuilder, который является
    ...
    function Clone: TAnsiStringBuilder;
  end;
...
constructor TAnsiStringBuilder.Create(Capacity: Integer);
begin
...
constructor TAnsiStringBuilder.Create(const S: AnsiString; StartIndex, Count: Integer);
var
  L: Integer;
  P: Pointer;
begin
...
constructor TAnsiStringBuilder.Create(P: Pointer; L: Integer);
begin
  if L > 0 then
  begin
    FLength := L;
...
procedure TAnsiStringBuilder.SetLength(NewLength: Integer);
begin
  if NewLength >= 0 then
  begin
...
procedure TAnsiStringBuilder.EnsureCapacity(Capacity: Integer);
begin
  if FCapacity < Capacity then
    SetCapacity(G_NormalizeCapacity(Capacity));
end;

procedure TAnsiStringBuilder.Fill(C: AnsiChar; Index, Count: Integer);
var
  L: Integer;
begin
  Dec(Index);
...
function TAnsiStringBuilder.Append(N: Integer): TAnsiStringBuilder;
var
  L, M, NewL: Integer;
  P: PAnsiChar;
  Negative: Boolean;
...
function TAnsiStringBuilder.Append(N: LongWord; Digits: Integer;
  Hexadecimal: Boolean): TAnsiStringBuilder;
var
  L, NewL, NewC: Integer;
  P: PAnsiChar;
  M: LongWord;
...
function TAnsiStringBuilder.Append(N: Int64): TAnsiStringBuilder;
var
  L, NewL, NewC: Integer;
  P: PAnsiChar;
  M: Int64;
...
function TAnsiStringBuilder.Append(C: AnsiChar): TAnsiStringBuilder;
begin
...
function TAnsiStringBuilder.Append(C: AnsiChar; Count: Integer): TAnsiStringBuilder;
var
  NewL, NewC: Integer;
begin
  if Count > 0 then
...
function TAnsiStringBuilder.Append(const S: AnsiString): TAnsiStringBuilder;
var
  L, NewL, NewC: Integer;
begin
  L := System.Length(S);
...
function TAnsiStringBuilder.Append(const S: AnsiString; Count: Integer): TAnsiStringBuilder;
var
...
function TAnsiStringBuilder.Append(const S: AnsiString; StartIndex, Count: Integer): TAnsiStringBuilder;
var
  L, NewL, NewC: Integer;
  P: Pointer;
begin
...
function TAnsiStringBuilder.Append(P: Pointer; L: Integer): TAnsiStringBuilder;
var
  NewL, NewC: Integer;
begin
  if L > 0 then
...
function TAnsiStringBuilder.AppendFormat(const Format: AnsiString;
  const Args: array of const): TAnsiStringBuilder;
begin
  Result := Append({$IFDEF UNICODE}AnsiStrings{$ELSE}SysUtils{$ENDIF}.Format(Format, Args));
end;

function TAnsiStringBuilder.AppendLine: TAnsiStringBuilder;
begin
  Result := Append(#13).Append(#10);
end;

function TAnsiStringBuilder.AppendLine(const S: AnsiString): TAnsiStringBuilder;
begin
  Result := Append(S).Append(#13).Append(#10);
end;

procedure TAnsiStringBuilder.Insert(Index: Integer; C: AnsiChar);
begin
  Dec(Index);
...
procedure TAnsiStringBuilder.Insert(Index: Integer; C: AnsiChar; Count: Integer);
var
  NewL, NewC: Integer;
begin
  Dec(Index);
...
procedure TAnsiStringBuilder.Insert(Index: Integer; const S: AnsiString);
var
  L, NewL, NewC: Integer;
begin
  Dec(Index);
...
procedure TAnsiStringBuilder.Insert(Index: Integer; const S: AnsiString; Count: Integer);
var
  L, SumL, NewL, NewC: Integer;
  X: Pointer;
begin
...
procedure TAnsiStringBuilder.Insert(Index: Integer; const S: AnsiString; StartIndex,
  Count: Integer);
var
  L, NewL, NewC: Integer;
  P: Pointer;
...
procedure TAnsiStringBuilder.Insert(Index: Integer; P: Pointer; L: Integer);
var
  NewL, NewC: Integer;
begin
  Dec(Index);
...
procedure TAnsiStringBuilder.Reverse;
begin
  if FLength > 1 then
    G_ReverseBytes(FChars, FLength);
end;

procedure TAnsiStringBuilder.Reverse(Index, Count: Integer);
var
  L: Integer;
begin
  Dec(Index);
...
procedure TAnsiStringBuilder.Delete(Index, Count: Integer);
var
  L, R: Integer;
begin
  Dec(Index);
...
procedure TAnsiStringBuilder.Replace(Index, Count: Integer;
  const S: AnsiString);
var
  L,R,I,M,K: Integer;
begin
  ...
  begin
    ...
    if R > 0 then
      G_MoveBytes(@FChars^[I], @FChars^[I + K], R);
  end
  // строка уменьшается
  else if K < 0 then
  begin
...
function TAnsiStringBuilder.ToString(Index, Count: Integer): AnsiString;
var
  L: Integer;
begin
  Dec(Index);
...
function TAnsiStringBuilder.Equals(SB: TAnsiStringBuilder): Boolean;
begin
  if SB = Self then
    Result := True
...
procedure TAnsiStringBuilder.TrimToSize;
begin
  if FLength < FCapacity then
    SetCapacity(FLength);
end;

function TAnsiStringBuilder.Clone: TAnsiStringBuilder;
begin
  Result := TAnsiStringBuilder.Create(FChars, FLength);
end;

procedure TAnsiStringBuilder.CopyFrom(ASource: TAnsiStringBuilder);
begin
  Clear;
